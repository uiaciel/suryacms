        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-5 fw-bolder text-white mb-2">
                            A Simple Content Management System for modern
                            Website
                        </h1>
                ...
                <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center">
                    <img alt="..." class="img-fluid rounded-3 my-5"
    ...
    <div class="container px-5 my-5">
        <div class="row gx-5">
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <livewire:suryacms::visitor-stats />
                ...
                <div class="col-lg-10 col-xl-7">
                    <div class="text-center">
                        <div class="fs-4 mb-4 fst-italic">
                            ...
                            tons
                            of development time when building new projects! Starting with a Bootstrap template
                            just
                            makes things easier!"
                        </div>
                        <div class="d-flex align-items-center justify-content-center">
                            <img alt="..." class="rounded-circle me-3"
            ...
            <div class="col-lg-8 col-xl-6">
                <div class="text-center">
                    ...
                    <p class="lead fw-normal text-muted mb-5">
                        ...
                        adipisicing elit. Eaque fugit ratione dicta mollitia. Officiis ad.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div
                ...
                <div class="ms-xl-4">
                    <div class="input-group mb-2">
                        <input aria-describedby="button-newsletter" aria-label="Email address..." class="form-control"

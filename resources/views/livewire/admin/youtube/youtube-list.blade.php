        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="border-b border-gray-200 p-4 flex items-center justify-between">
                <h5 class="text-lg font-bold text-gray-900 flex items-center gap-2">
                    <i class="fab fa-youtube text-red-600"></i> Video Library (YouTube)
                </h5>
                <button type="button" class="inline-flex items-center px-4 py-2 border border-red-600 text-red-600 font-semibold rounded-lg hover:bg-red-50 transition-colors" onclick="document.getElementById('youtubeModal').classList.remove('hidden')">
                    <i class="fas fa-plus-circle mr-1"></i> Add YT Video
                </button>
            </div>
            ...
            <div class="p-4">
                <div class="space-y-4">
                    ...
                    <div class="border-b border-gray-200 pb-4 flex flex-col md:flex-row md:items-center justify-between last:border-b-0 gap-4" wire:key="video-{{ $video->id }}">
                        <!-- Video Info -->
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 flex-1 min-w-0">
                            ...
                            <button
                                ...
                                class="w-full sm:w-32 flex-shrink-0 rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow"
                            >
                                <img src="{{ $video->thumbnail_url }}" alt="thumb" class="w-full h-24 sm:h-20 object-cover">
                            </button>

                            <!-- Details -->
                            <div class="flex-1 min-w-0">
                                <div class="font-bold text-gray-900 mb-2 truncate">{{ $video->title }}</div>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    >
                                        <i class="fas fa-play-circle mr-1"></i> View
                                    </button>
                        ...
                        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto" @click.stop>
                            ...
                            <div class="bg-gray-900 text-white p-6 flex items-center justify-between rounded-t-2xl">
                                <h5 class="text-lg font-bold flex items-center gap-2">
                                    <i class="fab fa-youtube"></i> Preview Video
                                </h5>
                    ...
                    <div class="text-center py-12 text-gray-500">
                        <i class="fas fa-film text-4xl mb-3 block text-gray-300"></i>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto" @click.stop>
            ...
            <div class="bg-red-600 text-white p-6 flex items-center justify-between rounded-t-2xl">
                <h5 class="text-lg font-bold flex items-center gap-2" id="youtubeModalLabel">
                    <i class="fab fa-youtube mr-2"></i> Add YouTube Video
                </h5>

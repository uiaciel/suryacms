<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 flex items-center gap-3">
                        <div class="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C6.248 6.253 2 10.998 2 12s4.248 5.747 10 5.747m0-13c5.752 0 10 4.998 10 5.747m0 0v13m0-13C17.752 6.253 22 10.998 22 12s-4.248 5.747-10 5.747m0 13v-13m0-13H2m20 13H2"></path>
                            </svg>
                        </div>
                        {{ $titlePage }}
                    </h1>
        ...
        <div x-data="{
            ...
            class="fixed top-4 right-4 z-50 w-80 transition-all duration-500"
            x-show="showAlert"
                            ...
                            <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
                                <div class="flex items-start justify-between gap-3 mb-3">
                                    <div class="flex items-center gap-3 flex-1">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-xs font-medium text-red-600 uppercase tracking-wide">📄 Attached PDF</p>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-700 mt-1">Use multimedia content to make your pages more engaging. You can add images, videos, and PDFs.</p>
                            </div>
                        </div>
                    </div>

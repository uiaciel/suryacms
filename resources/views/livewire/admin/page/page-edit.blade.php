            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav aria-label="breadcrumb" class="mt-4 sm:mt-0">
                    <ol class="flex flex-wrap gap-2 text-sm text-gray-600">
                        ...
                        <li><a href="/admin/pages" class="text-blue-600 hover:text-blue-700 hover:underline">Pages</a></li>
                        <li class="text-gray-400">/</li>
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    @error('language_id') <span class="text-red-600 text-sm mt-1">{{ $message }}</span> @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    @error('translation_id') <span class="text-red-600 text-sm mt-1">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            @endif
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                        ...
                        <div class="space-y-3">
                            ...
                            <div wire:ignore class="border-4 border-dashed border-gray-300 rounded-xl overflow-hidden bg-gray-50 hover:bg-white transition-colors">
                                <textarea
                                    id="content"
                                    wire:model="konten"
                                    name="konten"
                                    ...
                                    placeholder="Start typing your page content here... You can use bold, italic, lists, and more..."
                                >{{ old('konten', $konten) }}</textarea>
                            </div>
                        ...
                        <div class="p-4 bg-green-50 border border-green-200 rounded-lg">
                            <div class="flex items-start justify-between gap-3 mb-3">
                                <div class="flex items-center gap-3 flex-1">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-xs font-medium text-green-600 uppercase tracking-wide">📄 Attached PDF</p>
                                        <p class="text-sm text-gray-700 truncate break-all">{{ basename($pdf) }}</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="status" wire:model="status" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all">
                            ...
                            <div>
                                <label for="datepublish" class="block text-sm font-medium text-gray-700 mb-2">Publish Date</label>
                                <input type="date" id="datepublish" wire:model="datepublish" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all">
                                @error('datepublish')
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-700 mt-1">Use multimedia content to make your pages more engaging. You can add images and videos.</p>
                            </div>
                        </div>
                    </div>
        ...
        if (typeof Livewire !== 'undefined') {
            Livewire.on('imageSelectedFromGallery', (data) => {
                ...
                if (imageData && imageData.url && typeof tinymce !== 'undefined') {
                    ...
                    if (editor) {
                        const imgHtml = '<img src="' + imageData.url + '" alt="Gallery Image" style="max-width: 100%; height: auto;" />';

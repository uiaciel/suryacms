                    ...
                    <form wire:submit.prevent="storeMenu" class="space-y-4" x-data="menuForm()" x-cloak>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                id="type" wire:model.defer="type" x-model="selectedType" @change="toggleLinkInput"
                                required>
                        ...
                        <div class="space-y-2" x-show="selectedType === 'post'" x-transition>
                            ...
                            <select
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
                                id="post" wire:model="link" x-model="selectedPost" @change="updateLink">
                        ...
                        <div class="space-y-2" x-show="selectedType === 'page'" x-transition>
                            ...
                            <select
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
                                id="page" wire:model="link" x-model="selectedPage" @change="updateLink">
                        ...
                        <div class="space-y-2" x-show="selectedType === 'categoryPost'" x-transition>
                            <label for="categoryPost" class="block text-sm font-bold text-gray-900">Select
                                Category</label>
                            <select
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
                                id="categoryPost" wire:model="link" x-model="selectedCategoryPost" @change="updateLink">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                id="link" wire:model="link" x-model="customLink"
                                @input="$wire.link = customLink">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                id="name" wire:model="name" x-model="getName" required>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <select
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
                                id="parent_id" wire:model.defer="parent_id" x-model="selectedParent">
